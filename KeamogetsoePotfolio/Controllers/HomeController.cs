        ...
        public IActionResult Projects()
        {
            var projects = new List<Project>
            {
                new Project
                {
                    ...
                    Technologies = new List<string> {"Landbot", "GPT"} // Added GPT for clarity
                },
                new Project
                {
                    Title = "Whisper Vault",
                ...
                new Project
                {
                    Title = "Company Sentimental Dashboard",
                    Description = "Two Streamlit dashboards for company sentiment analysis: one using live API data, the other a mock data version. Utilizes Google Gemini API for NLP and Render for deployment.",
                    ImageUrl = "/images/company-sentiment-dashboard.png", // You'll need to create this image
                    GithubUrl = "https://github.com/Keamo0713/CompanySentimentalDashboard", // Link to the primary repo
                    LiveDemoUrl = "https://companysentimentaldashboard.onrender.com", // Link to the API version
                    Technologies = new List<string> { "Streamlit", "Google Gemini API", "pandas", "matplotlib", "seaborn", "fpdf", "scikit-learn", "Render" }
                },
                new Project
                {
